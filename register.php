            ...
            <div class="col-md-4 register-box">
                ...
                <form action="authenticate.php" method="post">
                        ...
                        <label for="username">Username</label>
                            <input type="text" class="form-control form-control-lg rounded-pill check_username" name="username" placeholder="username" required>
                            <small class="error_username" style="color: red;"></small>
                        </div>

                        <div class = "form-group fontuser">
                        <label for="email">Email</label>
                            <input type="email" class="form-control form-control-lg rounded-pill check_email" name="email" placeholder="email" required>
                            <small class="error_email" style="color: red;"></small>
                        </div>

                        <div class = "form-group fontpassword">
                        <label for="password">Password</label>
                            <input type="password" class="form-control form-control-lg rounded-pill check_password" name="password" placeholder="password" required>
                            <small class="error_Password" style="color: red;"></small>
                        </div>

                        <div class = "form-group fontpassword">
                        <label for="passwordConf">Confirm Password</label>
                            <input type="password" class="form-control form-control-lg rounded-pill check_confirm_password" name="passwordConf" placeholder="confirm password" required>
